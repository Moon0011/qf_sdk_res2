...
public class DialogUtil {
	 ...
	 * @param notice
	 */
	public static void showNoticeDialog(final Context context,final Notice notice){

//		final Notice notice = new Notice();
//		notice.setTitle("测试标题");
//		notice.setContent("测试内容测试内容测试内容测试内容测试内容");
//		notice.setTime("2017年1月17日16:02:00");
