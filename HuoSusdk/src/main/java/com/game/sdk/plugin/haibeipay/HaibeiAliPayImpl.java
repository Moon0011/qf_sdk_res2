...
public class HaibeiAliPayImpl extends IHuoPay {
    ...
    private String pay_type ="alipay_h5";//默认支付类型
    private PayListener payListener;
    //获取海贝付平台支付连接
    @Override
    public void startPay(final Activity activity, IPayListener listener, float money, PayResultBean payResultBean) {
        inits();
