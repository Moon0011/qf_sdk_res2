...
public class HuoRegisterView extends FrameLayout implements View.OnClickListener {
    ...
    public HuoRegisterView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setupUI();
    }

    public HuoRegisterView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setupUI() {
        ...
        LayoutInflater.from(getContext()).inflate(MResource.getIdByName(getContext(), MResource.LAYOUT, "huo_sdk_inlude_mobile_register"), this);
